...
if(!class_exists('userMetaFieldEditor')){
    class userMetaFieldEditor {
        ...
        function menuItem(){
            $page = add_submenu_page( 'usermeta', 'User Extra Field', 'User Extra Field', 'manage_options', 'user-meta-editor', array(__CLASS__, 'metaEditor'));
        ...
        function user_meta_editor_form_field($meta=array(), $meta_group, $remove_button=true){   
            ...
            $drag = '<span style="float:right;cursor:move;">Drag Me</span>';
        ...
        function inputForm(){
            ...
            add_meta_box("user_meta", "Profile field Group", array(__CLASS__, 'groupTab'), "group_tab", 'side', 'high');
            add_meta_box("user_meta", "Profile Meta Field", array(__CLASS__, 'metaTab'), "meta_tab", 'side', 'high');
            add_meta_box("user_meta", "Donations", array($userMeta, 'donation'), "donation_tab", 'side', 'high');
            add_meta_box("user_meta", "How to use", array(__CLASS__, 'manualTab'), "manual_tab", 'side', 'high');
            
            ?>
            <div class="wrap">	
                <?php if($showMessage) echo "<br /><div class='$showMessage[0]'>$showMessage[1]</div>" ?>
                
                <script src="<?php echo $userMeta->pluginUrl(); ?>/js/jquery-1.6.2.js"></script>
                <script src="<?php echo $userMeta->pluginUrl(); ?>/js/jquery.ui.core.js"></script>
                <script src="<?php echo $userMeta->pluginUrl(); ?>/js/jquery.ui.widget.js"></script>
                <script src="<?php echo $userMeta->pluginUrl(); ?>/js/jquery.ui.mouse.js"></script>
                <script src="<?php echo $userMeta->pluginUrl(); ?>/js/jquery.ui.sortable.js"></script>
                ...
                <div id="dashboard-widgets-wrap">
                    <div class="metabox-holder">
                        <div style="float:left; width:70%;" class="inner-sidebar1">
                            <?php do_meta_boxes('group_tab','side',''); ?>
                        </div>
                        ...
                        <div style="float:left; width:70%;" class="inner-sidebar1">
                            <?php do_meta_boxes('meta_tab','side',''); ?>
                        </div>    

                        <div style="float:right; width:28%;" class="inner-sidebar1">
                            <?php do_meta_boxes('manual_tab','side',''); ?>
                        </div>                                             
        ...
        function manualTab(){
            ...
            echo "<p><b>[user-meta-profile] </b> : Frontend user profile</p>";
        }
