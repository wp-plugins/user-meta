...
class umSupportModel {
    ...
    function nonceField(){
        global $userMeta;
        return wp_nonce_field( $userMeta->settingsArray('nonce'), 'pf_nonce', true, false );
    }
    ...
    function boxHowToUse(){
        ...
        $html .= "<div><center><a class='button-primary' href='http://user-meta.com'>Visit Plugin Site</a></center></div>";
        return $html;
    }
    ...
    function boxGetPro(){
        ...
        $html .= "<li>Register user by Email.</li>";
        $html .= "<p></p>";
    ...
    function boxShortcodesDocs(){
        ...
        $html .= "<center><a class='button-primary' href='http://user-meta.com/documentation/' target='_blank'>Read Moe</a></center>";
        $html .= "</div>";
        return $html;        
    }
    
    function getProLink( $label=null ){
        $label = $label ? $label : "http://user-meta.com";
        return "<a href='http://user-meta.com' target='_blank'>$label</a>";
    }
