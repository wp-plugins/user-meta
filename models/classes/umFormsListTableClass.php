...
if ( ! class_exists( 'umFormsListTable' ) ) :
class umFormsListTable extends WP_List_Table {
    ...
    function column_name( $item ) {
        ...
        $actions = array(
            ...
            'delete'    => sprintf( '<a href="?page=usermeta&form=%1$s&action=delete" onclick="if(confirm(\'%2$s\')){return true;}return false;">Delete</a>', urlencode( $item['form_key'] ), 
                    "You are about to delete this form \'{$item['form_key']}\'.  \'Cancel\' to stop, \'OK\' to delete." ),
        );
    ...
    function column_shortcode( $item ) {
        return "<p><strong>Profile: </strong>[user-meta-profile form=\"{$item['form_key']}\"]</p>"
        . "<p><strong>Registration: </strong>[user-meta-registration form=\"{$item['form_key']}\"]</p>";
    }
    ...
    function column_cb( $item ) {
        return sprintf(
            ...
            /*$2%s*/ $item['form_key']                //The value of the checkbox should be the record's id
        );
    }
