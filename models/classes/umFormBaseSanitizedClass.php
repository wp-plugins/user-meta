...
if ( ! class_exists( 'umFormBaseSanitized' ) ) :
class umFormBaseSanitized extends umFormBase {
    ...
    /**
     * Valid form's fields for insert/update. Return field_name as array key.
     * 
    ...
    function validInputFields() {
        ...
        foreach ( $this->formFields as $field ) {
            ...
            if ( ! empty( $field['admin_only'] ) && ! $this->isAdmin ) continue;
            if ( ! empty( $field['non_admin_only'] ) && $this->isAdmin ) continue;
            if ( ! empty( $field['read_only_non_admin'] ) && ! $this->isAdmin ) continue;
     ...
     */
    function hasCaptcha() {
        if ( empty( $this->data['fields'] ) ) return false;
        if ( ! is_array( $this->data['fields'] ) ) return false;
