 ...
 */
  ...
  * Use instance of $pluginFramework to access framework method
  * Use plugin instance (eg. $userMeta) for accessing plugins method
  */
    ...
    class pluginFramework {
        ...
        function loadScript(){
            ...
            foreach( $scripts as $key => $data ){
                ...
                /*$scriptData = explode('.', $url);            
                $scriptType = $scriptData[ count($scriptData) - 1 ];     
                if( $scriptType == 'css' )
        ...
        function test5(){
            ...
            //echo $this->test5();
            //$PluginFrameworkSupport = new PluginFrameworkSupport;
            return 'test4';
            //echo $this->modelsPath;
...
//$pluginFramework->runTest();    
//$pluginFramework->registerScript('xyz.css', false);  
