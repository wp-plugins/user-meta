...
if (!class_exists( 'PluginFrameworkWPSupport' )){
    class PluginFrameworkWPSupport {
        ...
        function loadShortcodeScriptStyle(){
            global $pluginFramework;
            //$pluginFramework->script = 
        }
        ...
        //live
        /*function listDefaultUserFields(){
            $defaultFields = array(
            'user_login'    => 'Username', 
            'user_email'    => 'Email', 
            'user_pass'     => 'Password', 
        ...
        //sleep
        function frmkModelTest(){
            return 'Framework Model Test';
        }       
