...
if (!class_exists('umShortcodesController')) :
    class umShortcodesController {
        ...
        function init( $atts ){     
            ...
            $output = null;
            if( @$_REQUEST['action_type'] == 'profile' )
                $output = $this->ajaxInsertUser();
        ...
        function generateForm( $formName, $actionType ){
            ...
            if( !$user_ID )
                return $userMeta->showMessage( 'You do not have permission to access this page.', 'info', false );
        ...
        function ajaxInsertUser(){
            ...
            if($error)
                ...
                $output = $userMeta->showMessage( $message, 'success', false );
            }
