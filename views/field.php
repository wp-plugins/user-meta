...
$field_types_options = $userMeta->getFields( 'box_group', $box_group, 'title' );
...
$fieldDivideDiv = $userMeta->createInput( "fields[$id][divide_div]", "checkbox", array( 
    "value"     => isset($divide_div) ? $divide_div : null,
    "after"     => " Divide this block <br />",
 ) );     
...
if( $field_type == 'user_login' ):
    ...
    $html .= "<div class='um_segment'><p>By default, <b>Required</b> and <b>Unique</b> role will be set with this field. <b>Read Only</b> will be set conditionaly.</p></div>";   

elseif( $field_type == 'user_email' ):
    $html .= "$fieldSize";
    $html .= "<div class='um_segment'>$fieldRetypeEmail $fieldAdminOnly $fieldReadOnly</div>";
    $html .= "$fieldMaxChar $fieldCssClass $fieldCssStyle";  
    $html .= "<div class='um_segment'><p>By default, <b>Required</b> and <b>Unique</b> role will be set with this field.</p></div>";   

elseif( $field_type == 'user_pass' ):
    $html .= "$fieldSize";
    $html .= "<div class='um_segment'>$fieldRetypePassword $fieldPasswordStrength $fieldRequired $fieldAdminOnly $fieldReadOnly</div>";
    $html .= "$fieldMaxChar $fieldCssClass $fieldCssStyle";  
...
elseif( $field_type == 'file' ):  
    $html .= "$fieldMetaKey";
    $html .= "<div class='um_segment'>$fieldRequired $fieldAdminOnly $fieldReadOnly $fieldUnique</div>";  
    $html .= "$fieldAllowedExtension $fieldMaxFileSize";
    $html .= "$fieldSize $fieldCssClass $fieldCssStyle";        
...
elseif( $box_group == 'wp_default' ):
    $html .= "$fieldSize";
    $html .= "<div class='um_segment'>$fieldRequired $fieldAdminOnly $fieldReadOnly $fieldUnique</div>";
    $html .= "$fieldMaxChar $fieldCssClass $fieldCssStyle";        

elseif( $box_group == 'standard' ):
    $html .= "$fieldMetaKey";
    $html .= "<div class='um_segment'>$fieldRequired $fieldAdminOnly $fieldReadOnly $fieldUnique</div>";
    $html .= "$fieldDefaultValue";
    $html .= "$fieldSize $fieldMaxChar $fieldCssClass $fieldCssStyle";     
    
elseif( $box_group == 'formating' ):
    $html .= "$fieldCssClass $fieldCssStyle";
endif;    
