...
<div class="form-group">
    <div class="col-xs-offset-3 col-xs-9 form-inline">
        ...
        <button type="button" class="btn btn-default um_conditional_plus"><i class="fa fa-plus"></i></button>
        <button type="button" class="btn btn-default um_conditional_minus"><i class="fa fa-minus"></i></button>
