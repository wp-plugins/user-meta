...
$fieldTitle = $userMeta->createInput( "field_title", "text", array( 
...
$fieldTypes = $userMeta->createInput( "field_type", "select", array( 
...
$fieldTitlePosition = $userMeta->createInput( "title_position", "select", array( 
...
$fieldDescription = $userMeta->createInput( "description", "textarea", array( 
...
$fieldMetaKey = $userMeta->createInput( "meta_key", "text", array( 
...
$fieldDefaultValue = $userMeta->createInput( "default_value", "textarea", array( 
...
$fieldOptions = $userMeta->createInput( "options", "textarea", array( 
...
$fieldUnique = $userMeta->createInput( "unique", "checkbox", array( 
...
$fieldRegistrationOnly = $userMeta->createInput( "registration_only", "checkbox", array( 
...
$fieldDisableAjax = $userMeta->createInput( "disable_ajax", "checkbox", array( 
    "value"     => isset($disable_ajax) ? $disable_ajax : null,
    "label"     => __( 'Disable AJAX upload', $userMeta->name ) . "<br />",
    "id"        => "um_fields_{$id}_disable_ajax",
) ); 
 
$fieldHideDefaultAvatar = $userMeta->createInput( "hide_default_avatar", "checkbox", array( 
...
$fieldDefaultRole = $userMeta->createInput( "default_value", "select", array( 
    "value"         => isset($default_value) ? $default_value : null,
...
$fieldRoleSelectionType = $userMeta->createInput( "role_selection_type", "radio", array( 
...
$fieldAllowedRoles = $userMeta->createInput( "allowed_roles", "checkbox", array( 
...
$fieldCssClass = $userMeta->createInput( "css_class", "text", array( 
...
$fieldCssStyle = $userMeta->createInput( "css_style", "textarea", array( 
...
$fieldSize = $userMeta->createInput( "field_size", "text", array( 
...
$fieldHeight = $userMeta->createInput( "field_height", "text", array( 
...
$fieldMaxChar = $userMeta->createInput( "max_char", "text", array( 
...
$fieldForceUsername = $userMeta->createInput( "force_username", "checkbox", array( 
...
$fieldRetypeEmail = $userMeta->createInput( "retype_email", "checkbox", array( 
    "value"     => isset($retype_email) ? $retype_email : null,
    "label"     => __( 'Retype Email', $userMeta->name ) . "<br />",
    "id"        => "um_fields_{$id}_retype_email",
 ) ); 
$fieldRetypePassword = $userMeta->createInput( "retype_password", "checkbox", array( 
...
$fieldPasswordStrength = $userMeta->createInput( "password_strength", "checkbox", array( 
...
$fieldRequiredCurrentPassword = $userMeta->createInput( "required_current_password", "checkbox", array( 
...
$fieldShowDivider = $userMeta->createInput( "show_divider", "checkbox", array( 
    "value"     => isset($show_divider) ? $show_divider : null,
    "label"     => __( 'Show Divider', $userMeta->name ) . "<br />",
    "id"        => "um_fields_{$id}_show_divider",
 ) );     
 
$fieldRichText = $userMeta->createInput( "rich_text", "checkbox", array( 
...
$fieldAllowedExtension = $userMeta->createInput( "allowed_extension", "text", array( 
...
$fieldDateTimeSelection = $userMeta->createInput( "datetime_selection", "select", array( 
...
$fieldDateFormat = $userMeta->createInput( "date_format", "text", array( 
...
$fieldCountrySelectionType = $userMeta->createInput( "country_selection_type", "select", array( 
...
$fieldMaxNumber = $userMeta->createInput( "max_number", "text", array( 
...
$fieldMinNumber = $userMeta->createInput( "min_number", "text", array( 
...
$fieldMaxFileSize = $userMeta->createInput( "max_file_size", "text", array( 
...
$fieldImageWidth = $userMeta->createInput( "image_width", "text", array( 
...
$fieldImageHeight = $userMeta->createInput( "image_height", "text", array( 
...
$fieldImageSize = $userMeta->createInput( "image_size", "text", array( 
...
$fieldRegex = $userMeta->createInput( "regex", "text", array( 
...
$fieldErrorText = $userMeta->createInput( "error_text", "text", array( 
...
$fieldCaptchaTheme = $userMeta->createInput( "captcha_theme", "select", array( 
...
$html .= $userMeta->renderPro( 'conditionalPanel', array(
    'id'            => $id,
    'conditional'   => ! empty( $conditions ) && is_array( $conditions ) ? $conditions : array(),
    'fieldList'     => $userMeta->fieldListforDropdown
), 'fields', true );
...
$metaBoxTitle = "<div class='um_admin_field_single'><span class='um_admin_field_title'>$field_title</span> (<span class='um_admin_field_type'>$field_type_title</span>) ID:<span class='um_field_id'>$id</span></div>";

$metaBoxOpen = true;
if( isset($n) )
    if( !($n == 1) ) $metaBoxOpen = false;

$html = $userMeta->metaBox( $metaBoxTitle, $html, true, $metaBoxOpen );

echo "<div class=\"um_field_single\">$html</div>";